...
BEGIN_MESSAGE_MAP(CSemanticBase, CDialogEx)
	...
	ON_MESSAGE(UDM_SEM_PA_GAIN_CONTROL1_CLICK, OnSemPaGainControl1Click)
	ON_MESSAGE(UDM_SEM_PA_GAIN_CONTROL2_CLICK, OnSemPaGainControl2Click)
...
BOOL CSemanticBase::UpdateSelected(UINT selected, BOOL bCommonControl)
{
	...
	case CSelect::LimAmp:
		...
		break;
	case CSelect::RegRef:
		if (Parent()->m_chip == _T("Zing200x") || Parent()->m_chip == _T("Zing400T")) {
