...
public:
	...
	void SetSliderGroup(UINT ss, int min, int max, CString strCurVal, int ticFreq, int lineSize, int pageSize, UINT idcStatic, void(*pControl)(int,int,CString,int,int,int)=NULL);
