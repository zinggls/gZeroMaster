...
CRawZing400T::CRawZing400T(CWnd* pParent /*=nullptr*/)
	: CRawBase(pParent)
{
	m_strList.push_back(&m_strRegOut24);
	m_strList.push_back(&m_strRegOut25);
...
BEGIN_MESSAGE_MAP(CRawZing400T, CDialogEx)
	...
	ON_BN_CLICKED(IDC_DEFAULT_VALUE_BUTTON, &CRawZing400T::OnBnClickedDefaultValueButton)
	ON_BN_CLICKED(IDC_WRITE_ALL_BUTTON, &CRawZing400T::OnBnClickedWriteAllButton)
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
void CRawZing400T::OnChipConnect(CString chipModel)
{
	...
	m_regMap.insert(std::pair<CString, CReg>(_T("RegOut24 [0]"), CReg(36, &m_strRegOut24, IDC_TX_REG_OUT24_STATIC)));
...
void CRawZing400T::DefaultValues(CString strChip)
{
	...
	m_strRegOut26 = _T("0x88");
	m_strRegOut27 = _T("0x7F");
	m_strRegOut28 = _T("0x0F");
	m_strRegOut29 = _T("0xE1");
	m_strRegOut2A = _T("0xFC");
	m_strRegOut2B = _T("0x3F");
	UpdateData(FALSE);
}