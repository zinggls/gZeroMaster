...
BEGIN_MESSAGE_MAP(CSemanticZing400T, CSemanticBase)
	...
	ON_MESSAGE(UDM_SEM_VSPS_PA_BIAS_VOLTAGE_CLICK, OnSemVspsPaBiasVoltageClick)
	ON_MESSAGE(UDM_SEM_VSPS_VGA_BIAS_VOLTAGE_CLICK, OnSemVspsVgaBiasVoltageClick)
	ON_MESSAGE(UDM_SEM_VSPS_CS_BIAS_VOLTAGE_CLICK, OnSemVspsCsBiasVoltageClick)
